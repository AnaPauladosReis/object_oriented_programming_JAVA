...
public class Entrada {
    ...
    public static int solicitarSubMenu(int menu){
        ...
        if(menu == 0 ){
            ...
            opcoes = new String[]{" Registrar produtos ", " Ver produtos registrados ", " Atualizar produto registrado ", " Remover produto registrado ", " Voltar "};
        } else if (menu == 1) {
            titulo = " Estoque de produtos ";
            opcoes = new String[]{" Adicionar produtos ao estoque ", " Ver produtos no estoque ", " Vender produtos ", " Atualizar produto no estoque ", " Remover produto do estoque ", " Voltar "};
        } else{
            return 0;
        }
